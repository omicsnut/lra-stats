...
struct Cli {
    ...
    #[arg(short, long, value_parser, default_value_t = String::from("lra-stats"))]
    out_prefix: String,
}
...
fn run_lra_stats(args: &Cli) {
    ...
    agg_stats.write_as_json(args.out_prefix.clone() + ".aggregate.json");
    full_stats.write_as_arrow(args.out_prefix.clone() + ".read_level.feather");
}
